...
const rulesRestrictFunctionsAndCalculations = {
  restrictFunctionsAndCalculationsInFilters: true,
};

const rulesNoRestrictions = {};

describe('validateFilters', () => {
  it('should not throw if filters is undefined', () => {
    expect(() => validateFilters(undefined, rulesNoRestrictions)).not.toThrow();
  });
  ...
  it('should throw if a filter is missing the field property', () => {
    expect(() =>
      validateFilters(
        // @ts-expect-error - Intentionally invalid: filter missing required field property
  ...
  it('should throw if a Set Filter has a function when rules restrict', () => {
    ...
    expect(() =>
      validateFilters(
        ...
        rulesRestrictFunctionsAndCalculations,
      ),
    ).toThrow(
  ...
  it('should throw if a Set Filter has a calculation when rules restrict', () => {
  ...
  it('should not throw if a Set Filter has a calculation when rules do not restrict', () => {
    const field = { calculation: 'QUARTER([Order Date])' } as const;
    expect(() =>
      validateFilters(
        [
  ...
  it('should throw if a Match Filter has no startsWith, endsWith, or contains', () => {
    ...
    expect(() =>
      validateFilters(
        // @ts-expect-error - Intentionally invalid: MATCH filter missing startsWith/endsWith/contains
        [filter],
        rulesNoRestrictions,
      ),
    ).toThrow(
